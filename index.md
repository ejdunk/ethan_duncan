...
[View code in Github](https://github.com/ejdunk/europa-chaos-ML)

[View Abstract](https://ui.adsabs.harvard.edu/abs/2022AGUFM.P23A..04D/abstract)

---

### H2knOw: Using AI to Connect People to Safe Water

H2knOw is a web interface allows individuals in water stressed countries to locate the closest functioning water points to their location In this project. I built a tree-based XGBoost model using scikit-learn.

<img src="images/H2knOw_webpage.png?raw=true" />

[![](https://img.shields.io/badge/Python-white?logo=Python)](#) [![](https://img.shields.io/badge/Jupyter-white?logo=Jupyter)](#)

[View code on Colab](https://colab.research.google.com/drive/1lSl-9Qg9lfrIUYClTejjBHMEGF8FE815?usp=sharing)
